const CACHE='schoolyard-buddies-pwa-v14-3-2';
const CORE=['./','./index.html','./game.html','./manifest.webmanifest','./assets/schoolyard-logo.png','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
